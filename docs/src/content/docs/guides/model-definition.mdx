...
- `Tenant` opts the model into tenant filtering and write injection.
- `NoTenant` disables global tenant behavior for a model.
- `Shard` maps model queries to a shard group.
